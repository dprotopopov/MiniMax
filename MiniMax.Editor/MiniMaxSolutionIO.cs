...
{
    public class MiniMaxSolutionIO : DataGridView
    {
        ...
        public MiniMaxSolutionIO()
        {
            InitializeDataGridView(DimentionSize, DimentionSize);
        }

        public MiniMaxSolutionIO(int nRows, int nCols)
        {
            InitializeDataGridView(nRows, nCols);
        }

        public MiniMaxSolutionIO(Point location, int nRows, int nCols)
        {
            InitializeDataGridView(nRows, nCols);
            Location = location;
        }
